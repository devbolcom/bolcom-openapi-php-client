...
class Example
{
    ...
    private static function getProduct($params = '')
    {
        ...
        if (self::$bRaw != 0) {
            ...
            $product = new BolCom\Product($response->products[0]);
    ...
    private static function getOffer($params = '')
    {
        ...
        if (self::$bRaw != 0) {
            ...
            foreach ($response->offerData->offers as $child) {
                $offers = new BolCom\Offers($child);
    ...
    private static function getRecommendations($params = '')
    {
        ...
        if (self::$bRaw != 0) {
            ...
            foreach ($response->products as $child) {
                $list[] = new BolCom\Product($child);
            }

            foreach ($list as $item) {
                if ($item instanceof BolCom\Product) {
        ...
        if (self::$bRaw != 0) {
            ...
            if (isset($response->productFamilies)) {
                ...
                foreach ($response->productFamilies as $child) {
                    $list[] = new BolCom\ProductFamilies($child);
                }
                foreach ($list as $item) {
                    if ($item instanceof BolCom\ProductFamilies) {
    ...
    private static function postBasket()
    {
        ...
        if (self::checkSession()) {
            ...
            $product = new BolCom\Product($responseProduct->products[0]);
    ...
    private static function getBasket()
    {
        ...
        if (self::checkSession()) {
            ...
            if (self::$bRaw != 0) {
                ...
                $basket = new BolCom\Basket($response);
                ...
                if (isset($response->basketItems)) {
                    ...
                    foreach ($response->basketItems as $item) {
                        $listitem[] = new BolCom\BasketItem($item);
                        $listproduct[] = new BolCom\BasketItemProduct($item->product);
                    }
            ...
            if (self::$bRaw != 0) {
                ...
                if (isset($response->wishListItems)) {
                    ...
                    foreach ($list as $child) {
                        $product = new BolCom\Product($child);
                        self::printProduct($product);
                    }
                } else {
